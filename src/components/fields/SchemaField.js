...
import {
  ...
  deepEquals,
  getSchemaType
} from "@react-schema-form/core/lib/utils";
...
function SchemaFieldRender(props) {
  const { uiSchema, formData, errorSchema, idPrefix, name, required, registry } = props;
...
if (process.env.NODE_ENV !== "production") {
  SchemaField.propTypes = {
    ...
    registry: PropTypes.shape({
      ...
      FieldTemplateObject: PropTypes.func,
      FieldTemplatePrimitive: PropTypes.func,
      FieldTemplatePrimitiveInline: PropTypes.func,
